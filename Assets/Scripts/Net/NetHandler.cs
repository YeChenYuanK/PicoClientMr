...
namespace LekeNet
{
    ...
    public class NetHandler : EventDispatcher
    {
        ...
        public void RegisterNetHandler(int opcode, PacketHandle packetHandle)
        {
            this.packetDict[opcode] = packetHandle;
        }

        public void RegisterNetHandler(OpCode opcode, PacketHandle packetHandle)
        {
